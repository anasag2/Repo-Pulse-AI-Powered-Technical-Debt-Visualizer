...
export default function AvatarButton({ size = 28, className }: { size?: number; className?: string }) {
  ...
  return (
    <>
      ...
      >
        <Avatar avatar={current} name={user?.name} size={size} />
      </button>
        ...
        >
          ...
          >
            <div className="flex items-center justify-between px-4 h-12 border-b border-border">
              ...
              <button onClick={() => setOpen(false)} className="text-muted-foreground hover:text-foreground p-1" data-testid="button-avatar-close">
                <X className="w-4 h-4" />
              </button>
            </div>
